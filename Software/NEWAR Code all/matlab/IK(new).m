...
motorAxes = dhtrans(0, 0, Ra-Rb, -pi/2); % The general motor axes
motor1 = motorAxes * trans(0, 0, -22.3);
motor2 = rotz(2*pi/3) * motorAxes * trans(0, 0, -22);
motor3 = rotz(4*pi/3) * motorAxes * trans(0, 0, -22);
